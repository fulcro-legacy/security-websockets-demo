...
`src/main/security_demo/client.cljs` contains the code to start and refresh
...
application `security-demo.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/security_demo.jar
```
